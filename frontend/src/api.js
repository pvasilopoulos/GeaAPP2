...
export const api = {
  ...
  sellers: (opts) => get('/sellers', opts),
  createSeller: (payload) => send('POST', '/sellers', payload),
  updateSeller: (id, payload) => send('PATCH', `/sellers/${id}`, payload),
  deleteSeller: (id) => send('DELETE', `/sellers/${id}`),
  ...
  notificationRuleScheduleEntities: (opts) => get('/notification-rules/schedule-entities', opts),
