...
export const PERMISSIONS = {
  ...
  QUOTES_MENU: 'quotes.menu', QUOTES_VIEW: 'quotes.view', QUOTES_CREATE: 'quotes.create', QUOTES_EDIT: 'quotes.edit', QUOTES_DELETE: 'quotes.delete', QUOTES_FETCH_LINES: 'quotes.fetch_lines', QUOTES_SEND_EMAIL: 'quotes.send_email', QUOTES_SEND_ERP: 'quotes.send_erp',
...
export const PERMISSION_CATALOG = [
  ...[
    ...
    ['QUOTES', 'Προσφορές', ['MENU', 'VIEW', 'CREATE', 'EDIT', 'DELETE', 'FETCH_LINES', 'SEND_EMAIL', 'SEND_ERP']],
  ].flatMap(([prefix, label, actions]) => actions.map((action) => ({
    code: P[`${prefix}_${action}`],
    label: `${{
      MENU: 'Menu', VIEW: 'Προβολή', CREATE: 'Δημιουργία', EDIT: 'Επεξεργασία', DELETE: 'Διαγραφή',
      FETCH_LINES: 'Λήψη γραμμών', SEND_EMAIL: 'Αποστολή email', SEND_ERP: 'Αποστολή στο ERP',
  ...
  { code: P.SELLERS_MANAGE, label: 'Διαχείριση πωλητών', group: 'Ρυθμίσεις οργανισμού' },
  { code: P.APP_SETTINGS_MANAGE, label: 'Ρυθμίσεις εφαρμογής', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.MESSAGING_MANAGE, label: 'Ρυθμίσεις μηνυμάτων', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.REMINDERS_MANAGE, label: 'Ρυθμίσεις υπενθυμίσεων', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.MENU_MANAGE, label: 'Διαχείριση μενού', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.CUSTOM_FIELDS_MANAGE, label: 'Διαχείριση custom fields', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.ERP_SYNC_MANAGE, label: 'Διαχείριση ERP Sync', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.NOTIFICATIONS_MANAGE, label: 'Διαχείριση ειδοποιήσεων', group: 'Ρυθμίσεις εφαρμογής' },
  { code: P.AUDIT_VIEW, label: 'Προβολή ιστορικού αλλαγών', group: 'Ρυθμίσεις εφαρμογής' },
