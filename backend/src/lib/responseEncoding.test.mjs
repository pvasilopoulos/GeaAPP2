...
import { charsetFromContentType, decodeResponse, parseEncodedJson } from './responseEncoding.js';
...
assert.equal(decodeResponse(encoded, { contentType: 'application/json; charset=windows-1253' }).text, JSON.stringify(payload));
