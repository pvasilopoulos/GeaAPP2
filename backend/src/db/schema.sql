...
CREATE TABLE quotes (
  ...
  erp_pushed_at DATETIME NULL,
  erp_push_status VARCHAR(20) NULL,
  erp_push_error TEXT NULL,
  erp_push_request MEDIUMTEXT NULL,
  erp_push_response MEDIUMTEXT NULL,
...
CREATE TABLE customers (
  ...
  next_action_followup_id BIGINT NULL,
  ...
  KEY idx_customers_next_action_followup (next_action_followup_id),
